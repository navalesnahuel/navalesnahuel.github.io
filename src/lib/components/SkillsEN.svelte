<script lang="ts">
    ...
    type SkillView = "technologies" | "tools" | "concepts";
    let activeView: SkillView = "technologies";
    ...
    const allSkills: CategorizedSkills = {
        technologies: [
            ...
            { name: "MongoDB", iconString: "skill-icons:mongodb" },
            { name: "Redis", iconString: "logos:redis" },
            { name: "Kafka", iconString: "simple-icons:apachekafka" },
        ...
        tools: [
            ...
            { name: "Google Cloud", iconString: "material-icon-theme:gcp" },
            {
                ...
                iconString: "material-icon-theme:azure",
            },
            {
                name: "Apache Hive",
...
<section class="skills py-12 md:py-20 bg-bg" id="skills">
    <Container xPadding="px-4 sm:px-6 lg:px-8">
        <SectionHeader
            title="Skills"
            subtitle="The technologies I work with and the concepts I apply."
        />
        ...
        <div class="skills-content-wrapper mt-6 md:mt-8">
            <div class="flex justify-center sm:justify-start mb-8 md:mb-10">
                ...
                >
                    <button
                        type="button"
                        on:click={() => (activeView = "technologies")}
                        class="px-3 py-1 xxs:px-4 xxs:py-1.5 text-xs sm:text-sm font-medium rounded-[7px] focus:outline-none"
                        class:bg-secondary={activeView === "technologies"}
                        class:text-bg={activeView === "technologies"}
                        class:shadow-md={activeView === "technologies"}
                        class:text-primary={activeView !== "technologies"}
                        class:opacity-70={activeView !== "technologies"}
                        class:hover:bg-grey={activeView !== "technologies"}
                        class:hover:opacity-100={activeView !== "technologies"}
                    >
                        Technologies
                    </button>
                    <button
                        type="button"
                        on:click={() => (activeView = "tools")}
                        class="px-3 py-1 xxs:px-4 xxs:py-1.5 text-xs sm:text-sm font-medium rounded-[7px] focus:outline-none ml-0.5"
                        class:bg-secondary={activeView === "tools"}
                        class:text-bg={activeView === "tools"}
                        class:shadow-md={activeView === "tools"}
                        class:text-primary={activeView !== "tools"}
                        class:opacity-70={activeView !== "tools"}
                        class:hover:bg-grey={activeView !== "tools"}
                        class:hover:opacity-100={activeView !== "tools"}
                    >
                        Tools
                    </button>
                    <button
                        type="button"
                        on:click={() => (activeView = "concepts")}
                        class="px-3 py-1 xxs:px-4 xxs:py-1.5 text-xs sm:text-sm font-medium rounded-[7px] focus:outline-none ml-0.5"
                        class:bg-secondary={activeView === "concepts"}
                        class:text-bg={activeView === "concepts"}
                        class:shadow-md={activeView === "concepts"}
                        class:text-primary={activeView !== "concepts"}
                        class:opacity-70={activeView !== "concepts"}
                        class:hover:bg-grey={activeView !== "concepts"}
                        class:hover:opacity-100={activeView !== "concepts"}
                    >
                        Concepts
                    </button>
                </div>
